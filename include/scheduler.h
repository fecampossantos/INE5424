...
// LOST
template <typename T>
class Scheduling_Queue<T, LOST> : public Multihead_Scheduling_List<T>
{
};
...
template <typename T>
class Scheduling_Queue<T, PMS> : public Multihead_Scheduling_List<T>
{
};
